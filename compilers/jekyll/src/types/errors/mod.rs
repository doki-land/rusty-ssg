...
impl From<crate::types::config::ConfigError> for VutexError {
    fn from(e: crate::types::config::ConfigError) -> Self {
        VutexError::ConfigError { message: e.to_string() }
    }
}
...
impl From<crate::JekyllError> for VutexError {
    fn from(e: crate::JekyllError) -> Self {
        VutexError::ConfigError { message: e.to_string() }
    }
}

impl From<crate::CollectionError> for VutexError {
    fn from(e: crate::CollectionError) -> Self {
        VutexError::ConfigError { message: e.to_string() }
    }
}

impl From<crate::LiquidError> for VutexError {
    fn from(e: crate::LiquidError) -> Self {
        VutexError::ConfigError { message: e.to_string() }
    }
}

impl From<crate::MarkdownError> for VutexError {
    fn from(e: crate::MarkdownError) -> Self {
        VutexError::ConfigError { message: e.to_string() }
    }
}

impl From<crate::PostError> for VutexError {
    fn from(e: crate::PostError) -> Self {
        VutexError::ConfigError { message: e.to_string() }
    }
}
