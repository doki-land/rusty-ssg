...
impl PluginHostError {
    ...
    pub fn i18n_key(&self) -> &'static str {
        match self {
            PluginHostError::ProcessStartError { .. } => "vuepress.error.plugin_host.process_start",
            PluginHostError::IoError { .. } => "vuepress.error.plugin_host.io",
            PluginHostError::JsonError { .. } => "vuepress.error.plugin_host.json",
            PluginHostError::Timeout { .. } => "vuepress.error.plugin_host.timeout",
            PluginHostError::ProcessShutdown => "vuepress.error.plugin_host.process_shutdown",
            PluginHostError::InvalidResponse => "vuepress.error.plugin_host.invalid_response",
        }
    }
